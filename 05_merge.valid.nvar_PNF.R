...
library(openxlsx)
write.xlsx(df_PGS.sm_Pathway, "/projects/rpci/wchs/pnfioric/pgs_wchs/WCHS_BrCa_pgs/PGS.matching.summary_WCHS_BrCa.xlsx", colWidths = "auto")
write.csv(df_PGS.sm_Pathway, "/projects/rpci/wchs/pnfioric/pgs_wchs/WCHS_BrCa_pgs/PGS.matching.summary_WCHS_BrCa.csv", row.names = F)
