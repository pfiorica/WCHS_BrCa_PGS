...
library(openxlsx)
write.xlsx(df_PGS_Pathway, "/projects/rpci/wchs/pnfioric/pgs_wchs/WCHS_BrCa_pgs/WCHS_BrCa_6_PGS.xlsx", colWidths = "auto")
write.csv(df_PGS_Pathway, "/projects/rpci/wchs/pnfioric/pgs_wchs/WCHS_BrCa_pgs/WCHS_BrCa_6_PGS.xlsx.csv", row.names = F)
